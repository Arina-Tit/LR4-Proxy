...
namespace proxy
{
    public class SimpleProxyServer
    {
        ...
        public SimpleProxyServer(int port, IPAddress address = null)
        {
            _listenPort = port;
            _listenAddress = address ?? IPAddress.Any;
        }
        ...
        public async Task StartAsync()
        {
            ...
            Console.WriteLine($"Proxy server started on {_listenAddress}:{_listenPort}");
